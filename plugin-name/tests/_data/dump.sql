...
CREATE TABLE `wp_commentmeta` (
  ...
  `meta_key` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL,
  `meta_value` longtext COLLATE utf8mb3_bin DEFAULT NULL,
  PRIMARY KEY (`meta_id`),
...
CREATE TABLE `wp_comments` (
  ...
  `comment_author` tinytext COLLATE utf8mb3_bin NOT NULL,
  `comment_author_email` varchar(100) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `comment_author_url` varchar(200) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `comment_author_IP` varchar(100) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `comment_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `comment_date_gmt` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `comment_content` text COLLATE utf8mb3_bin NOT NULL,
  `comment_karma` int(11) NOT NULL DEFAULT 0,
  `comment_approved` varchar(20) COLLATE utf8mb3_bin NOT NULL DEFAULT '1',
  `comment_agent` varchar(255) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `comment_type` varchar(20) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
...
INSERT INTO `wp_comments` VALUES (1,1,'A WordPress Commenter','wapuu@wordpress.example','https://wordpress.org/','','2016-09-15 15:16:23','2016-09-15 15:16:23','Hi, this is a comment.\nTo get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.\nCommenter avatars come from <a href=\"https://gravatar.com\">Gravatar</a>.',0,'1','','',0,0);
...
CREATE TABLE `wp_links` (
  ...
  `link_url` varchar(255) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `link_name` varchar(255) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `link_image` varchar(255) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `link_target` varchar(25) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `link_description` varchar(255) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `link_visible` varchar(20) COLLATE utf8mb3_bin NOT NULL DEFAULT 'Y',
  `link_owner` bigint(20) unsigned NOT NULL DEFAULT 1,
  `link_rating` int(11) NOT NULL DEFAULT 0,
  `link_updated` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `link_rel` varchar(255) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `link_notes` mediumtext COLLATE utf8mb3_bin NOT NULL,
  `link_rss` varchar(255) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  PRIMARY KEY (`link_id`),
...
CREATE TABLE `wp_options` (
  ...
  `option_name` varchar(191) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `option_value` longtext COLLATE utf8mb3_bin NOT NULL,
  `autoload` varchar(20) COLLATE utf8mb3_bin NOT NULL DEFAULT 'yes',
...
CREATE TABLE `wp_posts` (
  ...
  `post_content` longtext COLLATE utf8mb3_bin NOT NULL,
  `post_title` text COLLATE utf8mb3_bin NOT NULL,
  `post_excerpt` text COLLATE utf8mb3_bin NOT NULL,
  `post_status` varchar(20) COLLATE utf8mb3_bin NOT NULL DEFAULT 'publish',
  `comment_status` varchar(20) COLLATE utf8mb3_bin NOT NULL DEFAULT 'open',
  `ping_status` varchar(20) COLLATE utf8mb3_bin NOT NULL DEFAULT 'open',
  `post_password` varchar(20) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `post_name` varchar(200) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `to_ping` text COLLATE utf8mb3_bin NOT NULL,
  `pinged` text COLLATE utf8mb3_bin NOT NULL,
  `post_modified` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `post_modified_gmt` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `post_content_filtered` longtext COLLATE utf8mb3_bin NOT NULL,
  `post_parent` bigint(20) unsigned NOT NULL DEFAULT 0,
  `guid` varchar(255) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `menu_order` int(11) NOT NULL DEFAULT 0,
  `post_type` varchar(20) COLLATE utf8mb3_bin NOT NULL DEFAULT 'post',
  `post_mime_type` varchar(100) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
...
INSERT INTO `wp_posts` VALUES (1,1,'2016-09-15 15:16:23','2016-09-15 15:16:23','Welcome to WordPress. This is your first post. Edit or delete it, then start writing!','Hello world!','','publish','open','open','','hello-world','','','2016-09-15 15:16:23','2016-09-15 15:16:23','',0,'http://another.dev/?p=1',0,'post','',1),(2,1,'2016-09-15 15:16:23','2016-09-15 15:16:23','This is an example page. It\'s different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:\n\n<blockquote>Hi there! I\'m a bike messenger by day, aspiring actor by night, and this is my website. I live in Los Angeles, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin\' caught in the rain.)</blockquote>\n\n...or something like this:\n\n<blockquote>The XYZ Doohickey Company was founded in 1971, and has been providing quality doohickeys to the public ever since. Located in Gotham City, XYZ employs over 2,000 people and does all kinds of awesome things for the Gotham community.</blockquote>\n\nAs a new WordPress user, you should go to <a href=\"http://another.dev/wp-admin/\">your dashboard</a> to delete this page and create new pages for your content. Have fun!','Sample Page','','publish','closed','open','','sample-page','','','2016-09-15 15:16:23','2016-09-15 15:16:23','',0,'http://another.dev/?page_id=2',0,'page','',0),(3,0,'2016-09-15 15:52:45','0000-00-00 00:00:00','foo','foo','foo','draft','open','open','','','','','2016-09-15 15:52:45','0000-00-00 00:00:00','',0,'http://another.dev/?p=3',0,'post','',0);
...
INSERT INTO `wp_term_relationships` VALUES (1,1,0),(3,1,0);
...
CREATE TABLE `wp_term_taxonomy` (
  ...
  `taxonomy` varchar(32) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
...
CREATE TABLE `wp_terms` (
  ...
  `name` varchar(200) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `slug` varchar(200) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
...
CREATE TABLE `wp_users` (
  `ID` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_login` varchar(60) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `user_pass` varchar(255) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `user_nicename` varchar(50) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `user_email` varchar(100) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `user_url` varchar(100) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `user_registered` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `user_activation_key` varchar(255) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  `user_status` int(11) NOT NULL DEFAULT 0,
  `display_name` varchar(250) COLLATE utf8mb3_bin NOT NULL DEFAULT '',
  PRIMARY KEY (`ID`),
...
INSERT INTO `wp_users` VALUES (1,'admin','$P$B/Sn5B37uJp0gPk6Va76CjEjXsLwlp/','admin','amdin@another.dev','','2016-09-15 15:16:23','',0,'admin');
...
INSERT INTO `wp_2_comments` VALUES (1,1,'A WordPress Commenter','wapuu@wordpress.example','http://wordpress/','','2019-12-16 15:30:18','2019-12-16 15:30:18','Hi, this is a comment.\nTo get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.\nCommenter avatars come from <a href=\"https://gravatar.com\">Gravatar</a>.',0,'1','','',0,0);
...
INSERT INTO `wp_2_posts` VALUES (1,1,'2019-12-16 15:30:18','2019-12-16 15:30:18','Welcome to <a href=\"http://wordpress/\">Test Sites</a>. This is your first post. Edit or delete it, then start writing!','Hello world!','','publish','open','open','','hello-world','','','2019-12-16 15:30:18','2019-12-16 15:30:18','',0,'http://test1.wordpress/?p=1',0,'post','',1),(2,1,'2019-12-16 15:30:18','2019-12-16 15:30:18','<!-- wp:paragraph -->\n<p>This is an example page. It\'s different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:quote -->\n<blockquote class=\"wp-block-quote\"><p>Hi there! I\'m a bike messenger by day, aspiring actor by night, and this is my website. I live in Los Angeles, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin\' caught in the rain.)</p></blockquote>\n<!-- /wp:quote -->\n\n<!-- wp:paragraph -->\n<p>...or something like this:</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:quote -->\n<blockquote class=\"wp-block-quote\"><p>The XYZ Doohickey Company was founded in 1971, and has been providing quality doohickeys to the public ever since. Located in Gotham City, XYZ employs over 2,000 people and does all kinds of awesome things for the Gotham community.</p></blockquote>\n<!-- /wp:quote -->\n\n<!-- wp:paragraph -->\n<p>As a new WordPress user, you should go to <a href=\"http://test1.wordpress/wp-admin/\">your dashboard</a> to delete this page and create new pages for your content. Have fun!</p>\n<!-- /wp:paragraph -->','Sample Page','','publish','closed','open','','sample-page','','','2019-12-16 15:30:18','2019-12-16 15:30:18','',0,'http://test1.wordpress/?page_id=2',0,'page','',0);
...
INSERT INTO `wp_3_comments` VALUES (1,1,'A WordPress Commenter','wapuu@wordpress.example','http://wordpress/','','2019-12-16 15:30:22','2019-12-16 15:30:22','Hi, this is a comment.\nTo get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.\nCommenter avatars come from <a href=\"https://gravatar.com\">Gravatar</a>.',0,'1','','',0,0);
...
s:11:\"contributor\";a:2:{s:4:\"name\";s:11:\"Contributor\";s:12:\"capabilities\";a:5:{s:10:\"edit_posts\";b:1;s:4:\"read\";b:1;s:7:\"level_1\";b:1;s:7:\"level_0\";b:1;s:12:\"delete_posts\";b:1;}}s:10:\"subscriber\";a:2:{s:4:\"name\";s:10:\"Subscriber\";s:12:\"capabilities\";a:2:{s:4:\"read\";b:1;s:7:\"level_0\";b:1;}}}','yes'),(96,'widget_search','a:2:{i:2;a:1:{s:5:\"title\";s:0:\"\";}s:12:\"_multiwidget\";i:1;}','yes'),(97,'widget_recent-posts','a:2:{i:2;a:2:{s:5:\"title\";s:0:\"\";s:6:\"number\";i:5;}s:12:\"_multiwidget\";i:1;}','yes'),(98,'widget_recent-comments','a:2:{i:2;a:2:{s:5:\"title\";s:0:\"\";s:6:\"number\";i:5;}s:12:\"_multiwidget\";i:1;}','yes'),(99,'widget_archives','a:2:{i:2;a:3:{s:5:\"title\";s:0:\"\";s:5:\"count\";i:0;s:8:\"dropdown\";i:0;}s:12:\"_multiwidget\";i:1;}','yes'),(100,'widget_meta','a:2:{i:2;a:1:{s:5:\"title\";s:0:\"\";}s:12:\"_multiwidget\";i:1;}','yes'),(101,'sidebars_widgets','a:4:{s:19:\"wp_inactive_widgets\";a:0:{}s:9:\"sidebar-1\";a:3:{i:0;s:8:\"search-2\";i:1;s:14:\"recent-posts-2\";i:2;s:17:\"recent-comments-2\";}s:9:\"sidebar-2\";a:3:{i:0;s:10:\"archives-2\";i:1;s:12:\"categories-2\";i:2;s:6:\"meta-2\";}s:13:\"array_version\";i:3;}','yes'),(102,'widget_pages','a:1:{s:12:\"_multiwidget\";i:1;}','yes'),(103,'widget_calendar','a:1:{s:12:\"_multiwidget\";i:1;}','yes'),(104,'widget_media_audio','a:1:{s:12:\"_multiwidget\";i:1;}','yes'),(105,'widget_media_image','a:1:{s:12:\"_multiwidget\";i:1;}','yes'),(106,'widget_media_gallery','a:1:{s:12:\"_multiwidget\";i:1;}','yes'),(107,'widget_media_video','a:1:{s:12:\"_multiwidget\";i:1;}','yes'),(108,'widget_tag_cloud','a:1:{s:12:\"_multiwidget\";i:1;}','yes'),(109,'widget_nav_menu','a:1:{s:12:\"_multiwidget\";i:1;}','yes'),(110,'widget_custom_html','a:1:{s:12:\"_multiwidget\";i:1;}','yes'),(111,'widget_block','a:1:{s:12:\"_multiwidget\";i:1;}','yes'),(112,'disallowed_keys','','no'),(113,'comment_previously_approved','1','yes'),(114,'auto_plugin_theme_update_emails','a:0:{}','no'),(115,'auto_update_core_dev','enabled','yes'),(116,'auto_update_core_minor','enabled','yes'),(117,'auto_update_core_major','unset','yes'),(118,'wp_force_deactivated_plugins','a:0:{}','yes'),(119,'finished_updating_comment_type','0','yes'),(120,'cron','a:2:{i:1643225434;a:1:{s:28:\"wp_update_comment_type_batch\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:2:{s:8:\"schedule\";b:0;s:4:\"args\";a:0:{}}}}s:7:\"version\";i:2;}','yes'),(121,'db_upgraded','1','yes');
...
INSERT INTO `wp_3_posts` VALUES (1,1,'2019-12-16 15:30:22','2019-12-16 15:30:22','Welcome to <a href=\"http://wordpress/\">Test Sites</a>. This is your first post. Edit or delete it, then start writing!','Hello world!','','publish','open','open','','hello-world','','','2019-12-16 15:30:22','2019-12-16 15:30:22','',0,'http://test2.wordpress/?p=1',0,'post','',1),(2,1,'2019-12-16 15:30:22','2019-12-16 15:30:22','<!-- wp:paragraph -->\n<p>This is an example page. It\'s different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:quote -->\n<blockquote class=\"wp-block-quote\"><p>Hi there! I\'m a bike messenger by day, aspiring actor by night, and this is my website. I live in Los Angeles, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin\' caught in the rain.)</p></blockquote>\n<!-- /wp:quote -->\n\n<!-- wp:paragraph -->\n<p>...or something like this:</p>\n<!-- /wp:paragraph -->\n\n<!-- wp:quote -->\n<blockquote class=\"wp-block-quote\"><p>The XYZ Doohickey Company was founded in 1971, and has been providing quality doohickeys to the public ever since. Located in Gotham City, XYZ employs over 2,000 people and does all kinds of awesome things for the Gotham community.</p></blockquote>\n<!-- /wp:quote -->\n\n<!-- wp:paragraph -->\n<p>As a new WordPress user, you should go to <a href=\"http://test2.wordpress/wp-admin/\">your dashboard</a> to delete this page and create new pages for your content. Have fun!</p>\n<!-- /wp:paragraph -->','Sample Page','','publish','closed','open','','sample-page','','','2019-12-16 15:30:22','2019-12-16 15:30:22','',0,'http://test2.wordpress/?page_id=2',0,'page','',0);
...
INSERT INTO `wp_blogmeta` VALUES (1,1,'db_version','51917'),(2,1,'db_last_updated','0.83203200 1643225372'),(3,2,'db_version','51917'),(4,2,'db_last_updated','0.55981100 1643225373'),(5,3,'db_version','51917'),(6,3,'db_last_updated','0.29042700 1643225374');
...
INSERT INTO `wp_blogs` VALUES (1,1,'wordpress','/','2019-12-16 15:30:15','0000-00-00 00:00:00',1,0,0,0,0,0),(2,1,'test1.wordpress','/','2019-12-16 15:30:18','2019-12-16 15:30:18',1,0,0,0,0,0),(3,1,'test2.wordpress','/','2019-12-16 15:30:21','2019-12-16 15:30:21',1,0,0,0,0,0);
...
INSERT INTO `wp_registration_log` VALUES (1,'admin@wordpress','127.0.0.1',2,'2019-12-16 15:30:18'),(2,'admin@wordpress','127.0.0.1',3,'2019-12-16 15:30:22');
...
INSERT INTO `wp_site` VALUES (1,'wordpress','/');
...
LOCK TABLES `wp_usermeta` WRITE;
/*!40000 ALTER TABLE `wp_usermeta` DISABLE KEYS */;
INSERT INTO `wp_usermeta` VALUES (1,1,'nickname','admin'),(2,1,'first_name',''),(3,1,'last_name',''),(4,1,'description',''),(5,1,'rich_editing','true'),(6,1,'syntax_highlighting','true'),(7,1,'comment_shortcuts','false'),(8,1,'admin_color','fresh'),(9,1,'use_ssl','0'),(10,1,'show_admin_bar_front','true'),(11,1,'locale',''),(12,1,'wp_capabilities','a:1:{s:13:\"administrator\";b:1;}'),(13,1,'wp_user_level','10'),(14,1,'dismissed_wp_pointers',''),(15,1,'source_domain','wordpress'),(16,1,'primary_blog','1'),(17,1,'wp_2_capabilities','a:1:{s:13:\"administrator\";b:1;}'),(18,1,'wp_2_user_level','10'),(19,1,'wp_3_capabilities','a:1:{s:13:\"administrator\";b:1;}'),(20,1,'wp_3_user_level','10');
/*!40000 ALTER TABLE `wp_usermeta` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `wp_users` WRITE;
/*!40000 ALTER TABLE `wp_users` DISABLE KEYS */;
INSERT INTO `wp_users` VALUES (1,'admin','$P$BeNUMi7VJ78WaC92c4RPhBIb/ivcXv.','admin','admin@wordpress','','2019-12-16 15:30:15','',0,'admin',0,0);
/*!40000 ALTER TABLE `wp_users` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-01-26 19:29:34
