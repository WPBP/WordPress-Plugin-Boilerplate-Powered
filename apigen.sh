...
apigen generate --source=$slug/ --exclude=*CMB*,*WP-Admin-Notice*,*WP-Contextual-Help*,*CPT_Core*,*Taxonomy_Core*,*wp-background-processing*,*freemius*,*Plus*,*WP-Contextual-Help*,*WP-Admin-Notice* --destination=docs --title="Wordpress Plugin Boilerplate Powered"
